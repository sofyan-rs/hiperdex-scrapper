...
async function info(slug) {
    let genres = [];
    try {
        res = await axios.get(`https://mangaforfree.net/manga/${slug}`);
        ...
        $(genres_e).each((index, element) => {
            ...
            genre_slug = genre_url.replace('https://mangaforfree.net/manga-genre', '/genre');
        ...
        let ch_list = await chaptersList(`https://mangaforfree.net/manga/${slug}/ajax/chapters/`);
        return await ({
            'id': id,
            'page': manhwa_title,
...
async function chaptersList(url) {
    ...
    try {
        ...
        $('.version-chap li').each((index, element) => {
            ...
            slug = url.replace('https://mangaforfree.net/manga', '/chapter');
...
async function all(page) {
    let m_list = []
    try {
        res = await axios.get(`https://mangaforfree.net/manga-list/page/${page}`);
        const body = await res.data;
        const $ = cheerio.load(body);
        ...
        $('#loop-content .badge-pos-1').each((index, element) => {
            ...
            slug = url.replace('https://mangaforfree.net/manga', '/series');
            ...
            $(chapter).each((i, e) => {
                ...
                let c_slug = c_url.replace('https://mangaforfree.net/manga', '/chapter');
...
async function search(search, page) {
    let m_list = [];
    try {
        res = await axios.get(`https://mangaforfree.net/page/${page}/?s=${search}&post_type=wp-manga`);
        const body = await res.data;
        const $ = cheerio.load(body);
        let p_title = $('.c-blog__heading h1').text().trim();
...
async function latest(page) {
    let m_list = [];
    try {
        res = await axios.get(`https://mangaforfree.net/page/${page}`);
        const body = await res.data;
        const $ = cheerio.load(body);
        let p_title = $('.c-blog__heading h1').text().trim();
        $('#loop-content .badge-pos-1').each((index, element) => {
...
async function completed(page) {
    let m_list = [];
    try {
        res = await axios.get(`https://mangaforfree.net/completed/page/${page}`);
        const body = await res.data;
        const $ = cheerio.load(body);
        let p_title = $('.c-blog__heading h1').text().trim();
        $('#loop-content .badge-pos-1').each((index, element) => {
...
async function genre(genre, page) {
    let m_list = [];
    try {
        res = await axios.get(`https://mangaforfree.net/manga-genre/${genre}/page/${page}`);
        const body = await res.data;
        const $ = cheerio.load(body);
...
async function chapter(manga, chapter) {
    let ch_list = [];
    try {
        res = await axios.get(`https://mangaforfree.net/manga/${manga}/${chapter}`);
        const body = await res.data;
        const $ = cheerio.load(body);
        ...
        let manga_slug = manga_url.replace('https://mangaforfree.net/manga', '/series');
